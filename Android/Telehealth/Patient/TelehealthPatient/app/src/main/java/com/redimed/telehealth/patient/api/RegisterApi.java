...
public interface RegisterApi {
    ...
    @Multipart
    @POST("/api/uploadFile")
    void uploadFile(@Header("Authorization") String auth, @Header("DeviceID") String deviceId,
                    @Header("SystemType") String systemType, @Header("Cookie") String cookie,
                    @Part("userUID") String userUID, @Part("fileType") String fileType, @Part("bodyPart") String bodyPart,
