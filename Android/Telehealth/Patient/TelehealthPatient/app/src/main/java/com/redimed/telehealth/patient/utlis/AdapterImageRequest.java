 ...
 */
public class AdapterImageRequest extends RecyclerView.Adapter<AdapterImageRequest.ImageListViewHolder> {

    private final Context context;
    private final LayoutInflater inflater;
    private ArrayList<CustomGallery> fileUploads;

    public AdapterImageRequest(ArrayList<CustomGallery> fileUploads, Context context) {
