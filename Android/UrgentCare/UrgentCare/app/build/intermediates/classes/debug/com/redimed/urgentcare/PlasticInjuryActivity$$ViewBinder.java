...
public class PlasticInjuryActivity$$ViewBinder<T extends com.redimed.urgentcare.PlasticInjuryActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131558530, "field 'scrollViewPlasticInjury'");
    target.scrollViewPlasticInjury = finder.castView(view, 2131558530, "field 'scrollViewPlasticInjury'");
    view = finder.findRequiredView(source, 2131558528, "field 'rippleViewClosePlasticInjuryPage'");
    target.rippleViewClosePlasticInjuryPage = finder.castView(view, 2131558528, "field 'rippleViewClosePlasticInjuryPage'");
    view = finder.findRequiredView(source, 2131558531, "field 'rippleViewBtnPlasticInjury'");
    target.rippleViewBtnPlasticInjury = finder.castView(view, 2131558531, "field 'rippleViewBtnPlasticInjury'");
  ...
  @Override public void unbind(T target) {
    ...
    target.scrollViewPlasticInjury = null;
    target.rippleViewClosePlasticInjuryPage = null;
    target.rippleViewBtnPlasticInjury = null;
