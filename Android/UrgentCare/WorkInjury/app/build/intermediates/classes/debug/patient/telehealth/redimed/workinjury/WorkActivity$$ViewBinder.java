...
public class WorkActivity$$ViewBinder<T extends patient.telehealth.redimed.workinjury.WorkActivity> implements ViewBinder<T> {
  ...
  @Override public void unbind(T target) {
    ...
    target.lblCTRequire = null;
    target.lblCNRequire = null;
