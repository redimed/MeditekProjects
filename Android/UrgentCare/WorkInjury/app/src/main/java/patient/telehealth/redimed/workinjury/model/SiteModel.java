...
public class SiteModel implements Parcelable {
    ...
    public static final Parcelable.Creator<SiteModel> CREATOR = new Creator<SiteModel>() {
        @Override
        public SiteModel createFromParcel(Parcel source) {
            return new SiteModel(source);
        }
