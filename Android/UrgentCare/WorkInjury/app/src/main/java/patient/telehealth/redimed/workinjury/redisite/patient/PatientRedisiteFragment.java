...
public class PatientRedisiteFragment extends Fragment implements IPatientRedisiteView, View.OnClickListener, View.OnFocusChangeListener {
    ...
    @Bind(R.id.rvServiceRedisite) RecyclerView rvServiceRedisite;
    @Bind(R.id.radioGroupWork) RadioGroup radioGroupWork;
    @Bind(R.id.layoutPatientRedisite) LinearLayout layoutPatientRedisite;
    /* Patient Details */
    @Bind(R.id.spinnerSalutation) Spinner spinnerSalutation;
    @Bind(R.id.txtClaimNo) EditText txtClaimNo;
    @Bind(R.id.txtFamily) EditText txtFamily;
    @Bind(R.id.txtGiven) EditText txtGiven;
    @Bind(R.id.txtDOB) EditText txtDOB;
    @Bind(R.id.txtOccupation) EditText txtOccupation;
    @Bind(R.id.txtAddress) EditText txtAddress;
    @Bind(R.id.txtSuburb) AutoCompleteTextView txtSuburb;
    @Bind(R.id.txtPostCode) EditText txtPostCode;
    @Bind(R.id.txtHome) EditText txtHome;
    @Bind(R.id.txtMobile) EditText txtMobile;
    @Bind(R.id.txtWork) EditText txtWork;
    @Bind(R.id.txtNOK) EditText txtNOK;
    @Bind(R.id.txtNOKPhone) EditText txtNOKPhone;
    @Bind(R.id.txtNOKEmail) EditText txtNOKEmail;
    /* Health Insurance Details */
    @Bind(R.id.txtNumber) EditText txtNumber;
    @Bind(R.id.txtPositionNumber) EditText txtPositionNumber;
    @Bind(R.id.txtExpiry) EditText txtExpiry;
    @Bind(R.id.txtHealthFund) EditText txtHealthFund;
    @Bind(R.id.txtMembership) EditText txtMembership;
    @Bind(R.id.txtVeteran) EditText txtVeteran;
    @Bind(R.id.toggleInsurance) RadioGroup toggleInsurance;
    @Bind(R.id.toggleHospital) RadioGroup toggleHospital;
    @Bind(R.id.toggleCard) RadioGroup toggleCard;
    @Bind(R.id.btnInjury) Button btnInjury;
    @Bind(R.id.btnIllness) Button btnIllness;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btnSelectStaff:
                ...
                application.replaceFragment(getActivity(), fragmentSite, Key.fmStaffList, Key.fmRedisitePatient);
                break;
            case R.id.btnSelectSite:
                SiteListFragment fragmentStaff = new SiteListFragment();
                fragmentStaff.setArguments(bundle);
                application.replaceFragment(getActivity(), fragmentStaff, Key.fmSiteList, Key.fmRedisitePatient);
                break;
        }
    }
