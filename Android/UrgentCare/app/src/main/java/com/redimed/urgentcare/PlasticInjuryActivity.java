...
public class PlasticInjuryActivity extends AppCompatActivity implements CreateDatePicker.OnCompleteListener {
    ...
    @Bind(R.id.scrollViewPlasticInjury) ScrollView scrollViewPlasticInjury;
    @Bind(R.id.rippleViewClosePlasticInjuryPage) RippleView rippleViewClosePlasticInjuryPage;
    @Bind(R.id.rippleViewBtnPlasticInjury) RippleView rippleViewBtnPlasticInjury;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plastic_injury);
        ...
        OnTouchListenerRelativeLayout(scrollViewPlasticInjury, allEditTextEventOnTouchListener);
        TxtDOBCreateDatePicker(txtDOB);
        CloseMakeAppointmentPage(rippleViewClosePlasticInjuryPage);
        EditText[] allEditTextCheckRequire = {txtFirstName,txtLastName};
        SendMakeAppointment(rippleViewBtnPlasticInjury, allEditTextCheckRequire);
    ...
    public void mReadJsonData() {
        try {
            ...
            if  (f.exists()){
                ...
                ArrayAdapter adapter = new ArrayAdapter(PlasticInjuryActivity.this,android.R.layout.simple_list_item_1,surburb);
        ...
        rv.setOnRippleCompleteListener(new RippleView.OnRippleCompleteListener() {
            ...
            public void onComplete(RippleView rippleView) {
                if (!CheckValidateFrom(arr)) {
                    SweetAlertDialog eFDialog = new SweetAlertDialog(PlasticInjuryActivity.this, SweetAlertDialog.ERROR_TYPE);
                ...
                final SweetAlertDialog progressDialog = new SweetAlertDialog(PlasticInjuryActivity.this, SweetAlertDialog.PROGRESS_TYPE);
                ...
                urgentApi.sendUrgentRequest(jsonUrgentRequest, new Callback<JsonObject>() {
                    ...
                    public void success(JsonObject jsonObject, Response response) {
                        ...
                        SharedPreferences preferences = getSharedPreferences("information", MODE_PRIVATE);
                        final SweetAlertDialog pDialog = new SweetAlertDialog(PlasticInjuryActivity.this, SweetAlertDialog.SUCCESS_TYPE);
                    ...
                    public void failure(RetrofitError error) {
                        progressDialog.dismissWithAnimation();
                        SweetAlertDialog errorDialog = new SweetAlertDialog(PlasticInjuryActivity.this, SweetAlertDialog.ERROR_TYPE);
