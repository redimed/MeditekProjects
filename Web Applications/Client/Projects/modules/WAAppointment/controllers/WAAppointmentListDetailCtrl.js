...
app.controller('WAAppointmentListDetailCtrl', function(AuthenticationService, $state, $cookies, $scope, $stateParams, $modal, WAAppointmentService, toastr, PatientService, CommonService) {
    //get data detail
    o.loadingPage(true);
    WAAppointmentService.getDetailWAAppointmentByUid($stateParams.AppUID).then(function(response) {
        console.log('responseData', response);
        o.loadingPage(false);
        if (response.data !== null) {
            runAll(response.data)
        } else {
                ...
                var modalInstance = $modal.open({
                    ...
                    resolve: {
                        patientInfo: function() {
                           PatientService.postDatatoDirective(($scope.wainformation.TelehealthAppointment.PatientAppointment !==null)?$scope.wainformation.TelehealthAppointment.PatientAppointment:'');
                        }
                    }
