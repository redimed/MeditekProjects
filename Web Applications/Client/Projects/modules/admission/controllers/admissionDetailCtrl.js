...
app.controller('admissionDetailCtrl', function($scope, $timeout, $uibModal, AdmissionService, $stateParams, consultationServices) {
    ...
    if($scope.wainformation.Patients.length > 0){
        ...
        if($scope.wainformation.Patients[0].PatientMedicares.length > 0){
            $scope.admissionDetail.MedicareEligible = $scope.admissionDetail.MedicareEligible?$scope.admissionDetail.MedicareEligible:$scope.wainformation.Patients[0].PatientMedicares[0].MedicareEligible?$scope.wainformation.Patients[0].PatientMedicares[0].MedicareEligible:'';
            $scope.admissionDetail.MedicareReferenceNumber = $scope.admissionDetail.MedicareReferenceNumber?$scope.admissionDetail.MedicareReferenceNumber:$scope.wainformation.Patients[0].PatientMedicares[0].MedicareReferenceNumber?$scope.wainformation.Patients[0].PatientMedicares[0].MedicareReferenceNumber:'';
            $scope.admissionDetail.MedicareNumber = $scope.admissionDetail.MedicareNumber?$scope.admissionDetail.MedicareNumber:$scope.wainformation.Patients[0].PatientMedicares[0].MedicareNumber?$scope.wainformation.Patients[0].PatientMedicares[0].MedicareNumber:'';
            $scope.admissionDetail.ExpiryDate = $scope.admissionDetail.ExpiryDate?$scope.admissionDetail.ExpiryDate:$scope.wainformation.Patients[0].PatientMedicares[0].ExpiryDate?moment($scope.wainformation.Patients[0].PatientMedicares[0].ExpiryDate,'YYYY-MM-DD HH:mm:ss Z').format('DD/MM/YYYY'):'';
        }

        if($scope.wainformation.Patients[0].PatientDVAs.length > 0){
            $scope.admissionDetail.DVANumber = $scope.admissionDetail.DVANumber?$scope.admissionDetail.DVANumber:$scope.wainformation.Patients[0].PatientDVAs[0].DVANumber?$scope.wainformation.Patients[0].PatientDVAs[0].DVANumber:'';
        }

        if($scope.wainformation.Patients[0].PatientKins.length > 0){
            $scope.admissionDetail.KinFirstName = $scope.admissionDetail.KinFirstName?$scope.admissionDetail.KinFirstName:$scope.wainformation.Patients[0].PatientKins[0].FirstName?$scope.wainformation.Patients[0].PatientKins[0].FirstName:'';
            $scope.admissionDetail.KinLastName = $scope.admissionDetail.KinLastName?$scope.admissionDetail.KinLastName:$scope.wainformation.Patients[0].PatientKins[0].LastName?$scope.wainformation.Patients[0].PatientKins[0].LastName:'';
            $scope.admissionDetail.Relationship = $scope.admissionDetail.Relationship?$scope.admissionDetail.Relationship:$scope.wainformation.Patients[0].PatientKins[0].Relationship?$scope.wainformation.Patients[0].PatientKins[0].Relationship:'';
            $scope.admissionDetail.MobilePhoneNumber = $scope.admissionDetail.MobilePhoneNumber?$scope.admissionDetail.MobilePhoneNumber:$scope.wainformation.Patients[0].PatientKins[0].MobilePhoneNumber?$scope.wainformation.Patients[0].PatientKins[0].MobilePhoneNumber:'';
        }
    }
