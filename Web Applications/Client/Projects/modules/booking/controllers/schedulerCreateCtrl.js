...
/*Thao*/
app.controller('schedulerCreateDirectiveCtrl', function($scope, item, BookingService, RosterService, event, start, end, PatientService, $modal, $uibModal, $timeout, $modalInstance, toastr) {
    $scope.item = item;
    console.log('dfafafafd', $scope.item)
        $modalInstance.rendered.then(function() {
            App.initAjax();
            ComponentsDateTimePickers.init();
        });
