var app = angular.module('app.authentication.company.detail.site.controller',[
]);

app.controller('siteCtrl', function($scope, $modalInstance, modal_action, modal_data, modal_index){
