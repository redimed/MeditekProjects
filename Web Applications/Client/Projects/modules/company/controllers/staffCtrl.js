var app = angular.module('app.authentication.company.detail.staff.controller',[
]);

app.controller('staffCtrl', function($scope, $modalInstance, modal_action, modal_data, modal_index){
