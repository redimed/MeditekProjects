...
app.directive('telehealthDetail', function(AuthenticationService, $state, $cookies, WAAppointmentService, toastr, $modal, PatientService, CommonService, $stateParams) {
    return {
        restrict: 'E',
