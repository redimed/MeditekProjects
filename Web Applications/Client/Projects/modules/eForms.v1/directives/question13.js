					...
					if(scope.option.value2 == null || scope.option.value2 == ""){
						...
						for(var i = 1; i <= value; i++){
							...
							.append($compile("<div class='col-md-12'>&nbsp;</div><div class='col-md-12'>"+
								...
								"' /></div><div class='col-md-2'><button ng-click='Remove("+(parseInt(i)+parseInt(scope.option.value2)+2)+
								")'>Remove</button></div>"+
								"<div class='col-md-2'>&nbsp;</div>"+
								"<div class='col-md-2'>RegExp</div>"+
								"<div class='col-md-2'><input type='text' ng-model='option.regex"
								+(parseInt(i)+parseInt(scope.option.value2)+2)+"' /></div>"+
								"</div>")(scope));
						}
