	    ...
	    getAllFieldValueWithValidation: function(){
	        ...
	        for(var i = 0; i < fields.length; i++){
	            ...
	            if(typeof this.refs[fieldRef] !== 'undefined'){
	                ...
	                if(type !== 'table' && type !== 'label' && type !== 'labelh' && type !== 'rlh'){
	                        ...
	                        React.createElement("div", {className: "form-group", id: this.props.groupId}, 
	                            React.createElement("div", {className: "col-md-12"}, 
	                                React.createElement("span", {className: "form-control-static", 
	                                    dangerouslySetInnerHTML: {__html: markdown.toHTML(this.props.label)}})
	                            )
	                        )
	                    )
	                )
...
/***/ function(module, exports) {
	...
	/** @jsx React.DOM */module.exports = React.createClass({displayName: "module.exports",
		...
		render: function(){
	        return (
	            React.createElement("textarea", {ref: "markdown"})
	        )
		}
	})
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "module.exports",
	    ...
	    componentDidMount: function() {
	        ...
	        this.refs.formClientList.init(this.appointmentUID);
	    },
	    ...
	    _onComponentFormListSelect: function(item) {
	        ...
	        swal({
	            ...
	            history.push('/eform/detail/appointment/' +self.appointmentUID+ '/form/'+item.ID);
	        })
	    },
	                                ...
	                                this.state.list.map(function(l,index){
	                                    return (
	                                        React.createElement("tr", {key: index}, 
	                                            React.createElement("td", null, l.Name), 
	                                            React.createElement("td", null, 
	                                                React.createElement(Link, {to: "/eform/detail/appointment/"+this.appointmentUID+"/client/"+l.ID, className: "label label-sm label-success"}, 
	                                                    "View Form"
	                                                ), 
	                                                " ", 
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "module.exports",
		...
		_onComponentPageBarSaveForm: function(){
	        ...
	        EFormService.formClientSave({id: formId, content: content, name: this.state.name})
	        .then(function(){
	            swal("Success!", "Your form has been saved.", "success");
	            history.push('/eform?appointmentUID='+appointmentId);
	        })
		},
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "module.exports",
		...
		_onComponentPageBarSaveForm: function(){
	        ...
	        .then(function(){
	            swal("Success!", "Your form has been saved.", "success");
	            history.push('/eform?appoinmentUID='+appointmentId);
	        })
		},
		render: function(){
			return (
