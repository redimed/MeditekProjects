...
module.exports = React.createClass({
    ...
    _serverUpdateForm: function(data) {
        ...
        swal({
            title: 'Are you sure?',
            text: 'You will update eform template module',
            type: 'warning',
            ...
            EFormService.eformTemplateModuleUpdate(data)
                    ...
                    <form>
                        <div className="form-body">
                            <div className="form-group">
                                <label>EForm Template Module Name</label>
                                <CommonInputText placeholder="EForm Template Module Name..." ref="inputName"/>
                            </div>
