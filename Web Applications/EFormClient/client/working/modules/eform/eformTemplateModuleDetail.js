...
module.exports = React.createClass({
    ...
    _loadPreview: function() {
        EFormService.eformTemplateModuleDetail({ uid: this.props.params.templateModuleUID })
        .then(function(response) {
            this.refs.pageBar.setName(response.data.Name);
            this.refs.pageBarBottom.setName(response.data.Name);
            var EFormTemplateModule = response.data;
            var content = JSON.parse(response.data.EFormTemplateModuleData.TemplateModuleData);
            this.setState(function(prevState) {
                return {
                    name: EFormTemplateModule.Name,
