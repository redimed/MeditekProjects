...
/***/ function(module, exports, __webpack_require__) {
	...
	var _baobab = __webpack_require__(34);

	var _baobab2 = _interopRequireDefault(_baobab);

	var _reactDom = __webpack_require__(42);

	var _section = __webpack_require__(172);

	var _section2 = _interopRequireDefault(_section);

	var _math = __webpack_require__(178);
	...
	var EFormDetail = function (_Component) {
	    ...
	    function EFormDetail() {
	        _classCallCheck(this, EFormDetail);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(EFormDetail).call(this));

	        _this.list = new _baobab2.default({
	            sections: []
	        });
	        _this.page_list = new _baobab2.default({
	            sections: []
	        });
	        _this.pages = [];
	    ...
	    _createClass(EFormDetail, [{
	            ...
	            _main2.default.EFormTemplateDetail({ uid: this.template_uid }).then(function (response) {
	                ...
	                for (var i = 1; i <= pages; i++) {
	                    ...
	                    body.on('tap', function (event) {
	                        if (self.md.is('iPad') || self.md.is('iPhone')) document.activeElement.blur();
	                    });
	                    // DYNAMIC MODULE
	                    /*var s = ''
	        ...
	        key: '_onShowSection',
	        value: function _onShowSection(s_params) {
	            var ref = s_params.get('ref');
	        ...
	        key: '_onHideSection',
	        value: function _onHideSection(s_params) {
	            var ref = s_params.get('ref');
	            Data.obj.map(function (o) {
	                if (typeof o.d !== 'undefined' && o.d.s === ref) {
	                    if (o.type === 'r') {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'ul',
	                    { className: 'navbar', style: { marginTop: '20px' } },
	                    _react2.default.createElement(
	                        'li',
	                        null,
	                        _react2.default.createElement(
	...
	(0, _reactDom.render)(_react2.default.createElement(EFormDetail, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _emmett = __webpack_require__(35);
	...
	var _monkey = __webpack_require__(37);

	var _watcher = __webpack_require__(41);
	...
	var _update2 = __webpack_require__(39);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Section = function (_Component) {
	    ...
	    _createClass(Section, [{
	        ...
	        key: 'render',
	        value: function render() {
	            var title = this.props.params.get('title') !== '' ? 'block' : 'none';
	            var dynamic = this.props.dynamic ? 'block' : 'none';
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'ul',
	                    { className: 'toolbar', style: { display: dynamic } },
	                    _react2.default.createElement(
	                        'li',
	                        null,
	                        _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sign = __webpack_require__(176);
	    ...
	    _createClass(Row, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            this.objects_init.map(function (obj) {
	                var width = $(self.refs[obj]).width();
	                var height = $(self.refs[obj]).height();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Radio = function (_Component) {
	    ...
	    _createClass(Radio, [{
	        ...
	        key: "render",
	        value: function render() {
	            return _react2.default.createElement("input", { type: "radio", name: this.props.name, id: this.props.id, ref: "root", value: this.props.value });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Sign = function (_Component) {
	    ...
	    function Sign() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Sign).call(this));
	    }
	    ...
	    _createClass(Sign, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'canvas', ref: 'canvas' },
	                _react2.default.createElement(
	                    'div',
	                    { ref: 'real', style: { display: 'none' } },
	                    _react2.default.createElement(
	                        'ul',
	                        { className: 'toolbar' },
	                        _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    'button',
	                                    { onClick: this._onSign.bind(this) },
	                                    'Sign New'
	                                )
	                            )
	                        )
	                    ),
	                    _react2.default.createElement('img', { ref: 'image', src: '/images/nosign.gif', style: { width: '100%' }, id: this.props.name + '_image' })
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Date = function (_Component) {
	    ...
	    function Date() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Date).call(this));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ip = __webpack_require__(180);
