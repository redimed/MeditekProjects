...
var emailWorker = new EmailWorker(options);
//EVENTS
emailWorker
...
.on('error',function(payload){
	console.log("=======FIVEBEANS EMAIL_WORKER ERROR EVENT==========");
	console.log(payload);
})
//Emitted on close in the underlying client. No payload.
.on('close',function(){
	console.log("=======FIVEBEANS EMAIL_WORKER CLOSE EVENT==========");
})
//Worker has started processing. No payload.
.on('started',function(){
	console.log("=======FIVEBEANS EMAIL_WORKER STARTED EVENT==========");
})
//Worker has stopped processing. No payload.
.on('stopped',function(ev){
	console.log("=======FIVEBEANS EMAIL_WORKER STOPPED EVENT==========");
})
...
.on('info',function(payload){
	console.log("=======FIVEBEANS EMAIL_WORKER INFO EVENT==========");
	console.log(payload);
})
...
.on('warning',function(payload){
	console.log("=======FIVEBEANS EMAIL_WORKER WARNING EVENT==========");
	console.log(payload);
})
//The worker has reserved a job. The payload is the job id.
.on("job.reserved",function(payload){
	console.log("=======FIVEBEANS EMAIL_WORKER JOB.RESERVED EVENT==========");
	console.log(payload);
})
...
.on("job.deleted",function(payload){
	console.log("=======FIVEBEANS EMAIL_WORKER JOB.DELETED EVENT==========");
	console.log(payload);
})
//The worker has buried a job. The payload is the job id.
.on("job.buried",function(payload){
	console.log("=======FIVEBEANS EMAIL_WORKER JOB.BURIED EVENT==========");
	console.log(payload);
})

emailWorker.start(['EMAIL']);