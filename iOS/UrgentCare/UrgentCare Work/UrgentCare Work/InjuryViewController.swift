...
class InjuryViewController: UIViewController {
    ...
    func CheckDataSubmit(){
        ...
        InjuryDataChange.general.append(Context.EformtData(txtOtherBodyPart.text!, name: "other_part_affected", ref: "field_2_14_1", type: "eform_input_text", checked: "", refRow: "row_2_14"))
         InjuryDataChange.general.append(Context.EformtData(txtOtherMedicalHistory.text!, name: "other_medical_histor", ref: "field_2_18_1", type: "eform_input_text", checked: "", refRow: "row_2_18"))
