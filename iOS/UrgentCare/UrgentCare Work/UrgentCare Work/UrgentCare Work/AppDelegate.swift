...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didReceiveRemoteNotification userInfo: [NSObject : AnyObject]) {
        //NSNotificationCenter.defaultCenter().postNotificationName(Define.Got_Request_Trip, object: userInfo)
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.kreatived.UrgentCare_Sport" in the application's documents Application Support directory.
